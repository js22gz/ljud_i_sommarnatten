...
<body class="__BODY_CLASS__">
  ...
  <script>
    ...
    function updatePlayhead() {
      ...
      const position = `${ratio * wrap.clientWidth}px`;
      playhead.style.left = position;
      scrubHandle.style.left = position;
